<?php
	...
	if(strcmp($AppKey,$key)==0){
		...
		(city_name LIKE '%$city%') 
		AND (adultprice BETWEEN $minprice AND $maxprice)$category_class $aminity_class $tag_class $rating_class $today_class AND p_active=1 ORDER BY p_id ASC limit $start, $limit
		";
