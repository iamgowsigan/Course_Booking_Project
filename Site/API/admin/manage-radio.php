<?php
	...
	{ 
		...
		if(isset($_POST['submit']))
		{
			...
			$query = mysqli_query($con, "insert into radio(name,detail,price) values('$name','$detail','$price')");
				
				if ($query) {
					$ulog=$_SESSION['login'];
					$query = mysqli_query($con, "insert into adminlog(name,action) values('$ulog',$name.'radio Added')");
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "delete from radio  where id='$id'");
            $msg = "Deleted ";
            $uname = $_SESSION['login'];
            $queryy = mysqli_query($con, "insert into adminlog(name,action) values('$uname','radio item deleted')");
		...
		if ($_GET['action'] == 'act' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "UPDATE radio SET active='1' WHERE id=$id");
			$msg = "Activated ";
			header("location: ".$_SERVER['PHP_SELF']);
		...
		if ($_GET['action'] == 'dact' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "UPDATE radio SET active='0' WHERE id=$id");
			$msg = "Deactivated ";
			header("location: ".$_SERVER['PHP_SELF']);
					...
					<div class="content">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title">Radiology Management</h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal">Add Radiology</button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<table id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "Select * FROM radio");
														$cnt = 1;
															...
															<tr>
																<?php
																	...
																	<tr>
																		...
																		<td>
																			<img src="assets/images/x-rays.png" alt="image" width="40" >
																		</td>
													...
													<div class="modal-body">
														...
														<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
															...
															<div class="form-group text-center">
																<button class="btn btn-primary" type="submit" name="submit">Add Radio Test</button>
															</div>
