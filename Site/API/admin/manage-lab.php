<?php
	...
	{ 
		...
		if ($_GET['action'] == 'act' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "UPDATE lab SET active='1' WHERE id=$id");
			$msg = "Activated ";
			header("location: ".$_SERVER['PHP_SELF']);
		...
		if ($_GET['action'] == 'dact' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "UPDATE lab SET active='0' WHERE id=$id");
			$msg = "Deactivated ";
			header("location: ".$_SERVER['PHP_SELF']);
					...
					<div class="content">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title">Laboratory Management</h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal">Add Lab</button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
															...
															<tr>
																<?php
																	...
																	<tr>
																		...
																		<td>
																			<img src="assets/images/microscope.png" alt="image" width="40" >
																		</td>
