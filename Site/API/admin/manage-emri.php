<?php
	...
	{ 
		...
		if(isset($_POST['submit']))
		{
			...
			$query = mysqli_query($con, "insert into emri(name,detail,price) values('$name','$detail','$price')");
				
				if ($query) {
					$ulog=$_SESSION['login'];
					$query = mysqli_query($con, "insert into adminlog(name,action) values('$ulog',$name.'emri Added')");
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "delete from emri  where id='$id'");
            $msg = "Deleted ";
            $uname = $_SESSION['login'];
            $queryy = mysqli_query($con, "insert into adminlog(name,action) values('$uname','emri item deleted')");
		...
		if ($_GET['action'] == 'act' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "UPDATE emri SET active='1' WHERE id=$id");
			$msg = "Activated ";
			header("location: ".$_SERVER['PHP_SELF']);
		...
		if ($_GET['action'] == 'dact' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "UPDATE emri SET active='0' WHERE id=$id");
			$msg = "Deactivated ";
			header("location: ".$_SERVER['PHP_SELF']);
					...
					<div class="content">
						...
						<div class="container-fluid">
									...
									<div class="page-title-box">
										<div class="page-title-right">
											<ol class="breadcrumb m-0">
												...
												<li class="breadcrumb-item active">EMRI</li>
											</ol>
										</div>
										<h4 class="page-title">EMRI Management</h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal">Add EMRI</button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<table id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "Select * FROM emri");
														$cnt = 1;
															...
															<tr>
																<?php
																	...
																	<tr>
																		...
																		<td>
																			<img src="assets/images/electrocardiogram.png" alt="image" width="40" >
																		</td>
																		...
																		<td>
																			...
																			<a href="edit-lab?scid=<?php echo htmlentities($row['id']); ?>" ><i class="dripicons-document-edit"></i></a>
													...
													<div class="modal-body">
														...
														<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
															...
															<div class="form-group text-center">
																<button class="btn btn-primary" type="submit" name="submit">Add EMRI</button>
															</div>
